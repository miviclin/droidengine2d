...
public class Geometry {
	 ...
	 * @param numIndices Numero de indices (representan el orden en que se pintaran los vertices) para el que se
	 *            reservara memoria
	...
	/**
	 * Devuelve el numero de colores definidos en esta geometria (si la geometria utiliza colores, deberia haber 1 color
	 * por cada vertice)
	 * 
	...
	/**
	 * Agrega unas coordenadas de textura a la geometria. Las coordenadas UV iran asociadas al vertice que se encuentre
	 * en el mismo indice.
	 * 
	...
	/**
	 * Devuelve el numero de coordenadas UV definidas en esta geometria (si la geometria utiliza texturas, deberia haber
	 * 1 coordenadas UV por cada vertice)
	 * 
